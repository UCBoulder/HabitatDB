    ...
    buildUniqueRecordConditionExpression(table) {
        const uniqueRecordCondition = table.usesCompositeKey()
            ? new Condition()
                ...
                .merge(new Condition().attributeNotExist(table.sortKey), MERGE_STRATEGY.AND)
